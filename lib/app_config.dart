...
class AppConfig {
  static String copyright_text = "@ SkyFlora " + this_year; //this shows in the splash screen
  static String app_name = "SkyFlora Delivery Hero"; //this shows in the splash screen

  //configure this
  static const bool HTTPS = false;

  //configure this
  static const DOMAIN_PATH = "skyflora.org";
